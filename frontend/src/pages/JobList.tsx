...
const JobList = () => {
  ...
  return (
    <div className="mb-10">
      ...
      <div className="h-60 w-screen bg-slate-200 flex items-center justify-between">
        <h1 className="text-3xl font-bold ml-10">Find your dream job</h1>
        <svg
          className="h-3/4"
        ...
        >
          ...
          <path
            ...
            fill="#ccc"
          />
          <circle cx="325.02994" cy="26.9685" r="26.96851" fill="#6c63ff" />
          <path
          ...
          <path
            ...
            fill="#ccc"
          />
          <circle cx="222.02994" cy="143.9685" r="26.96851" fill="#6c63ff" />
          <path
          ...
          <path
            ...
            fill="#ccc"
          />
          <circle cx="441.70332" cy="226.5592" r="34.13884" fill="#6c63ff" />
          <path
      ...
      <div className="flex w-5/6  mx-auto items-center mt-10">
        <input
          className="w-1/2 px-3 py-1  rounded-md bg-slate-200 mr-5"
        ...
        />
        <button
          className="bg-violet-600 px-10 py-1 rounded-lg text-white"
      ...
      <div className="w-5/6 mx-auto mt-5">
        <div className="flex justify-between items-center">
          <h4 className="text-xl font-bold">All Jobs</h4>
          <h4 className="text-sm text-gray-400">Showing {jobs.length}</h4>
        </div>
        {jobs &&
          jobs.map((job) => (
            <div
              className="w-full border-2 border-x-gray-500 p-5 rounded-md mt-5 hover:bg-slate-50 cursor-pointer"
              onClick={() =>
                navigate(`/job-detail`, {
                  state: {
                    userId: job.id,
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <h2>
                  {job.company} -{" "}
                  <span className="bg-orange-100 text-sm px-2 py-1 rounded-md text-orange-500">
                    {job.type}
                  </span>
                </h2>
