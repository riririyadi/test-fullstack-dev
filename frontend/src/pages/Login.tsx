...
import setAuthToken from "../utils/SetAuthTokenHeader";
  ...
  return (
    <div className="w-screen h-screen flex">
      ...
      <div className="w-1/2 flex flex-col justify-center items-center">
        <form
          className="flex flex-col items-center justify-center rounded-lg py-10 w-10/12"
          onSubmit={handleLogin}
        >
          <h1 className="text-3xl font-bold mb-3 w-2/3 text-left">Login</h1>
          <h2 className="text-xl mb-10 w-2/3 ">
            Get into your account and find your dream job
          </h2>
          <input
            className="w-2/3 mb-2 px-3 py-1 rounded-md bg-slate-200"
          ...
          <button
            type="submit"
            className="bg-violet-600 text-white w-2/3 rounded-md  py-1 mt-4"
          >
            Login
          </button>
        </form>
